          ...
          {% include "menu-breadcrumbs" %}
            <div class="items-body">
              <div class="content-illustrations">
                ...
                <div class="content-body content-formatted" data-search-indexing-allowed="true">{% content name="gallery" title=gallery_title title_tooltip=gallery_title_tooltip %}</div>
              </div>
              ...
              <div class="content-body">
                ...
                <div class="content-body content-formatted" data-search-indexing-allowed="true">{% contentblock title=content_default_title title_tooltip=content_default_title_tooltip %}{{ "write_product_description_here" | lc: editor_locale }}{% endcontentblock %}</div>
              </div>
            </div>
        </main>
      </div>
