:root {
  ...
  */
  ...
  /* VoogStyle
    ...
    "scope": "global"
  */
  --blog-list-title-font-weight: 400;
  /* VoogStyle
    "pathI18n": ["blog", "title"],
  ...
  */
  ...
  /* VoogStyle
    ...
    "scope": "global"
  */
  --blog-list-title-text-transform: uppercase;
  /* VoogStyle
    "pathI18n": ["blog", "title"],
    "titleI18n": "color",
    "type": "button",
  ...
  */
  ...
  /* VoogStyle
    ...
    "scope": "global"
  */
  --blog-list-date-text-transform: uppercase;
  /* VoogStyle
    "pathI18n": ["blog", "date"],
    "titleI18n": "color",
    "type": "button",
